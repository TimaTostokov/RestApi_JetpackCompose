...
class RemoteDataSource @Inject constructor(private val postServices: PostServices) {
    ...
    suspend fun putPosts(id: String, body: PostResponseModel) = postServices.putPost(id = id, body = body)
    suspend fun patchPosts(id: String, body: PostResponseModel) = postServices.patchPost(id = id, body = body)
